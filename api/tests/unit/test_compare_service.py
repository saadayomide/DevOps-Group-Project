...
def test_find_cheapest():
    ...
    comparisons = [
        ProductComparison(
            product_id=1, product_name="Milk", store_id=1, store_name="Store A", price=2.99
        ),
        ProductComparison(
            product_id=1, product_name="Milk", store_id=2, store_name="Store B", price=2.49
        ),
    ]
...
def test_calculate_average_price():
    ...
    comparisons = [
        ProductComparison(
            product_id=1, product_name="Milk", store_id=1, store_name="Store A", price=2.0
        ),
        ProductComparison(
            product_id=1, product_name="Milk", store_id=2, store_name="Store B", price=4.0
        ),
    ]
